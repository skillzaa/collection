...
test(`del2`,()=>{expect(del2.data.id).toBe("2")});            
});
...
test(`del`,()=>{expect(del.data.id).toBe("5")});            
});
...
test(`del`,()=>{expect(del.errorNumber).toEqual(0)});            
test(`del`,()=>{expect(del.success).toBeTruthy()});            
test(`del`,()=>{expect(del.data.id).toBe("6")});            
});
